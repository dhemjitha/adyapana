...
public class ManageClassrooms extends javax.swing.JFrame {
    ...
    private void loadSubjects() {
        ...
        try {
            ...
            ResultSet resultSet = MySQLClass.executeSearch("SELECT * FROM `subject` ");
    ...
    private void loadMedium() {
        ...
        try {
            ...
            ResultSet resultSet = MySQLClass.executeSearch("SELECT * FROM `medium` ");
    ...
    private void loadDate() {
        ...
        try {
            ...
            ResultSet resultSet = MySQLClass.executeSearch("SELECT * FROM `date` ");

            @SuppressWarnings({"MismatchedQueryAndUpdateOfCollection", "UseOfObsoleteCollectionType"})
            Vector v = new Vector();

            v.add("Select classroom date");
            ...
            DefaultComboBoxModel subjectModel = new DefaultComboBoxModel(v);
            jComboBox4.setModel(subjectModel);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Select Medium");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setText("Class Fees");

        jTextField5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setText("Exam Year");
        ...
        jLabel10.setText("Manage Classroom");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageClassrooms().setVisible(true);
            }
        });
    }
